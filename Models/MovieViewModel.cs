...
namespace LazarNetMVCApp.Models {
    public class MovieViewModel {
        ...
        public MovieViewModel(int id, int movieId, string? movieTitle, string? moviePoster, DateTime? movieReleaseDate, string? movieOverview, double movieVoteAverage, Video movieTrailer, string? movieTrailerUrl) {
            this.id = id;
